...
int main(){
    ...
    subject allsub[7];
    allsub[0]=subject("Discrete meth","BCSE103E","Surath",4,{"C2","TC2","TCC2"});
    allsub[1]=subject("STS","sts","sts",1.5,{"A1,TA1"});
    allsub[2]=subject("AWS","aws","Maheshwari",2,{"F1","TF1"});
    allsub[3]=subject("AI","BCSE303L","bhavadharini",4,{"E2","TE2"});
    allsub[4]=subject("DBMS","BCSE303L","premlatha",4,{"D2","TD2","L5","L6"});
    allsub[5]=subject("Alok","BCSE303L","software",4,{"G2","TG2","L23","L24"});
    allsub[6]=subject("HSM","BCSE303L","someone",4,{"B1","TB1"});
    timetable t1(allsub,7);
    t1.clashcheck(allsub,7);
